...
Процедура ПриЗагрузкеБиблиотеки(Путь, СтандартнаяОбработка, Отказ)
	...
	Если Осень <> Неопределено Тогда
		ПутьДоЗаготовки = ОбъединитьПути(Путь, "src/Заготовки/ИнициализацияИнтефейсаКоманднойСтроки.os");
		ПодключитьСценарий(ПутьДоЗаготовки, "ИнициализацияИнтефейсаКоманднойСтроки");
		Осень.ДобавитьЗаготовкуДляАвтоИнициализации("ИнициализацияИнтефейсаКоманднойСтроки");
