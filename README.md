...
Третий - Команды оставить без изменений, но создать класс - дуб, который превратит ваши команды в желуди. Для понимая, приведу пример, как можно ожелудить небольшую команду:
